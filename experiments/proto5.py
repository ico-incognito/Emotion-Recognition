...
W4 = tf.get_variable("W4", [l3, op], initializer = tf.contrib.layers.xavier_initializer(), regularizer = tf.contrib.layers.l2_regularizer(scale = lambd))
b4 = tf.get_variable("b4", [1, op], initializer = tf.zeros_initializer())

W5 = tf.get_variable("W5", [l4, l5], initializer = tf.contrib.layers.xavier_initializer(), regularizer = tf.contrib.layers.l2_regularizer(scale = lambd))
b5 = tf.get_variable("b5", [1, l5], initializer = tf.zeros_initializer())

W6 = tf.get_variable("W6", [l5, op], initializer = tf.contrib.layers.xavier_initializer(), regularizer = tf.contrib.layers.l2_regularizer(scale = lambd))
b6 = tf.get_variable("b6", [1, op], initializer = tf.zeros_initializer())
...
cross_entropy = tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits(logits = Z6, labels = y))
