...
W4 = tf.get_variable("W4", [3200, 1024], initializer = tf.contrib.layers.xavier_initializer())
b4 = tf.get_variable("b4", [1, 1024], initializer = tf.zeros_initializer())
W5 = tf.get_variable("W5", [1024, op], initializer = tf.contrib.layers.xavier_initializer())
...
with tf.Session() as sess:
	...
	#saver.save(sess, 'model3/fyp3.ckpt')
	#print("W:", W4.eval())
